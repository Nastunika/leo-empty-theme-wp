 ...
 */
function leo_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'leo_content_width', 640 );
}
add_action( 'after_setup_theme', 'leo_content_width', 0 );
...
function leo_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'leo' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'leo' ),
...
//    var_dump( get_template_directory_uri() );
	...
	wp_enqueue_script( 'leo-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'leo-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
...
function themename_recommend_plugin() {
    ...
    $plugins = array(
        ...
        array(
            'name'		=> 'Page scroll to id', // http://wordpress.org/plugins/page-scroll-to-id/
        ...
        array(
            'name'		=> 'Advanced Custom Fields', // https://wordpress.org/plugins/advanced-custom-fields/
